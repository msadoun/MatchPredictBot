...
MENU_PREDICT = "⚽ توقع"
MENU_MATCHES = "📅 المباريات"
MENU_LEADERBOARD = "🏆 المتصدرين"
MENU_MY_PREDICTIONS = "📋 توقعاتي"
...
START_TEXT = (
    "مرحباً بك في بوت توقعات كأس العالم! ⚽\n\n"
    "استخدم القائمة أدناه أو الأوامر:\n"
    "/matches — عرض مباريات اليوم (أو /matches YYYY-MM-DD)\n"
    "/predict — اختر مباراة، ثم الفائز، ثم أدخل النتيجة\n"
    "/cancel — إلغاء التوقع الحالي\n"
    "/mypredictions — توقعاتك\n"
...
GROUP_WELCOME = (
    ...
    "الأوامر:\n"
    "/predict@{bot} — توقع نتيجة مباراة\n"
    "/matches@{bot} — مباريات اليوم\n"
    "/leaderboard@{bot} — لوحة المتصدرين\n"
    "/mypredictions@{bot} — توقعاتك\n\n"
...
PREDICTION_SAVED = "تم حفظ التوقع لـ {home} {vs} {away}:\n{score}"
...
LEADERBOARD_ROW = (
    "{medal} {name}\n"
    "   {points} نقطة · {count} توقعات · "
    "3ن:{exact} 2ن:{goals} 1ن:{winner}"
)
LEADERBOARD_TOP_N = "\nيعرض أفضل {shown} من {total} لاعب."
YOUR_RANK = "\n📍 ترتيبك: #{rank} · {points} نقطة · {count} توقعات"
SCORING_RULES = (
    "\nنظام النقاط: 3 نقاط نتيجة صحيحة · 2 نقاط أهداف الفائز · 1 نقطة توقع الفائز/التعادل"
)
