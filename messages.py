...
LEAGUE_SEASON_CONFIRM = (
    ...
    "• الدوري الإسباني: ريال مدريد × برشلونة\n"
    "• الدوري الإنجليزي: مانشستر يونايتد، سيتي، ليفربول، أرسنال، تشيلسي\n"
    "• دوري أبطال أوروبا: مواجهات إسبانيا × إنجلترا\n\n"
    "سيُحذف كل التوقعات والمباريات الحالية ويُصفّر الجميع.\n"
    "21 مباراة (11 محلية + 10 أبطال).\n"
