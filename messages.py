...
NO_OPEN_MATCHES = (
    ...
    "تظهر المباريات قبل انطلاقها بـ ٧٢ ساعة."
)

CHOOSE_MATCH = "اختر مباراة للتوقع ({date}):"
CHOOSE_MATCH_LEAGUE = (
    "اختر مباراة للتوقع — المباريات خلال الـ ٧٢ ساعة القادمة "
    "(الدوري أو دوري أبطال أوروبا):"
)
WHO_WINS = "من سيفوز؟"
...
SCORING_RULES = (
    ...
    "• 1 نقطة — الفائز فقط، أو التعادل بنتيجة مختلفة\n"
    "• 0 — توقع خاطئ\n\n"
    "⭐ أدوار الإقصاء: يمكنك مضاعفة نصف مباريات كل دور "
    "(والنهائي ومباراة المركز الثالث بالكامل).\n"
    "المضاعفة = 6 نقاط للنتيجة الدقيقة فقط، وإلا 0."
)
...
MY_PREDICTIONS_PICK_MONTH = "📋 توقعاتك — {team}\n\nاختر الشهر:"
MY_PREDICTIONS_TEAM_HEADER = "📋 توقعاتك — {team}"
MY_PREDICTIONS_MONTH_HEADER = "📋 توقعاتك — {team} · {month}"
MY_PREDICTIONS_MONTH_POINTS = "🏅 مجموع النقاط: {points}"
MY_PREDICTIONS_MONTH_BUTTON = "{month} · {points} نقطة"
MY_PREDICTIONS_TEAM_EMPTY = "لا توجد توقعات لمباريات {team}."
MY_PREDICTIONS_MONTH_EMPTY = "لا توجد توقعات لـ {team} في {month}."
MY_PREDICTIONS_BTN_TEAMS = "↩️ رجوع للفرق"
MY_PREDICTIONS_BTN_MONTHS = "↩️ رجوع للأشهر"
...
ADMIN_COMMANDS_TEXT = (
    "📖 أوامر المسؤول\n\n"
    "⚽ المباريات والنتائج\n"
    "• /setresult <رقم> <منزل> <ضيف> — تسجيل نتيجة\n"
    "• /allmatches — عرض كل المباريات\n"
    "• /closematch <رقم> — إغلاق مباراة\n"
    "• /openmatch <رقم> [clear] — فتح مباراة\n"
    ...
    "• /matchtable [رقم] — جدول توقعات مباراة\n"
    "• /matchphoto [رقم] — نفس جدول المباراة\n"
    "• /setprediction <telegram_id> <رقم> <نتيجة> — تعيين توقع\n"
    "• /importexcel — استيراد من Excel\n\n"
    "📊 النقاط\n"
    "• /setpoints <مستخدم> <نقاط> — نقاط أساسية\n"
    "• /setpoints total <مستخدم> <إجمالي>\n"
    "• /setpoints add <مستخدم> <نقاط>\n"
    "• /setgrouppoints <مجموعة> <مستخدم> <نقاط>\n"
    "• /setgrouppoints load alkoram3na — تحميل نقاط المجموعة\n"
    "• /userpoints <مستخدم> — تفصيل النقاط\n"
    "• /resetpoints confirm — تصفير نقاط الجميع\n\n"
    "💾 النسخ الاحتياطي\n"
    ...
    "• /resetall confirm — نفس إعادة الضبط\n"
    "• /factoryreset confirm — نفس إعادة الضبط"
)
BACKUP_PREDICTIONS_DONE = (
    "تم حفظ نسخة احتياطية ({count} توقع).\n"
    "الملف: {filename}"
)
...
LEAGUE_SEASON_CONFIRM = (
    "⚠️ بدء موسم جديد للأندية السبعة:\n"
    "• لكل نادٍ 5 مباريات محلية + 5 في دوري الأبطال\n"
    "• ضد فرق أخرى (لا مواجهات بين الأندية السبعة)\n\n"
    "سيُحذف كل التوقعات والمباريات الحالية ويُصفّر الجميع.\n"
    "70 مباراة إجمالاً (10 لكل نادٍ).\n"
    "المستخدمون يبقون مسجّلين.\n"
    "أرسل: /loadseason confirm"
)
LEAGUE_SEASON_DONE = (
    "✅ تم بدء الموسم الجديد.\n\n"
    "• توقعات محذوفة: {predictions_cleared}\n"
    "• مباريات محذوفة: {matches_cleared}\n"
    "• مستخدمون مُصفّرون: {users_zeroed}\n"
    "• مباريات جديدة: {seeded} (10 لكل نادٍ)\n"
    "• مباريات مفتوحة: {open}\n\n"
    "يمكن للمشاركين استخدام /predict أو /matches."
)
