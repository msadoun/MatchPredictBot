...
LEAGUE_SEASON_CONFIRM = (
    "⚠️ بدء دوري جديد (ريال مدريد، برشلونة، مانشستر يونايتد، مانشستر سيتي، "
    "ليفربول، أرسنال، تشيلسي):\n"
    "• حذف كل التوقعات والمباريات الحالية\n"
    "• تصفير نقاط الجميع\n"
    "• تحميل 21 مباراة (دور ذهاب واحد)\n\n"
    "المستخدمون يبقون مسجّلين.\n"
    "أرسل: /loadseason confirm"
)
LEAGUE_SEASON_DONE = (
    "✅ تم بدء الدوري الجديد.\n\n"
