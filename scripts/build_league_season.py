...
FIXTURES: list[tuple[str, str, str, str, str]] = [
    ...
    # Champions League — MD2–6 window (MD1 already played by mid-Sep 2026)
    # Kickoffs: 21:00/18:45 CEST (=19:00/16:45 UTC) through MD3; CET (=20:00/17:45 UTC) from MD4.
    ...
    m("BAR", TEAMS["BAR"], O["AVL"], kickoff("2026-11-03", "20:00:00"), 4, "ucl"),
    m("MU", TEAMS["MU"], O["ROM"], kickoff("2026-11-03", "20:00:00"), 4, "ucl"),
    m("MC", O["RBL"], TEAMS["MC"], kickoff("2026-11-04", "20:00:00"), 4, "ucl"),
    m("ARS", O["SLA"], TEAMS["ARS"], kickoff("2026-11-04", "20:00:00"), 4, "ucl"),
    m("RM", O["AEK"], TEAMS["RM"], kickoff("2026-11-04", "17:45:00"), 4, "ucl"),
    m("LIV", O["FEN"], TEAMS["LIV"], kickoff("2026-11-04", "17:45:00"), 4, "ucl"),
    m("MC", TEAMS["MC"], O["NAP"], kickoff("2026-11-24", "20:00:00"), 5, "ucl"),
    m("RM", TEAMS["RM"], O["PSV"], kickoff("2026-11-24", "20:00:00"), 5, "ucl"),
    m("ARS", TEAMS["ARS"], O["DOR"], kickoff("2026-11-24", "20:00:00"), 5, "ucl"),
